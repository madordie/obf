...
**/
- (instancetype)init;
- (instancetype)initWith(socketQueue):(nullable dispatch_queue_t)sq;
- (instancetype)initWith(delegate):(nullable id<GCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq;
- (instancetype)initWith(delegate):(nullable id<GCDAsyncSocketDelegate>)aDelegate delegateQueue:(nullable dispatch_queue_t)dq socketQueue:(nullable dispatch_queue_t)sq;
...
- (void)set(delegate):(nullable id<GCDAsyncSocketDelegate>)delegate delegateQueue:(nullable dispatch_queue_t)delegateQueue;
...
@property (atomic, assign, readwrite, getter=is(IPv4Enabled)) BOOL IPv4Enabled;
@property (atomic, assign, readwrite, getter=is(IPv6Enabled)) BOOL IPv6Enabled;

@property (atomic, assign, readwrite, getter=is(IPv4PreferredOverIPv6)) BOOL IPv4PreferredOverIPv6;
